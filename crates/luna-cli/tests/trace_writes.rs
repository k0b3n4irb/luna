...
fn rom(path: &Path) {
    let prog = [
        0xA9, 0x55, 0x8D, 0x22, 0x21, 0xA9, 0x22, 0x8D, 0x01, 0x43, 0xA9, 0x00, 0x8D, 0x02, 0x43,
        0xA9, 0x20, 0x8D, 0x03, 0x43, 0xA9, 0x7E, 0x8D, 0x04, 0x43, 0xA9, 0x04, 0x8D, 0x05, 0x43,
        0xA9, 0x00, 0x8D, 0x00, 0x43, 0xA9, 0x01, 0x8D, 0x0B, 0x42, 0xDB,
    ];
