...
| Platform | Asset |
|---|---|
| Linux x86_64 | `luna-v1.12.0-linux-x86_64.tar.gz` |
| Linux aarch64 | `luna-v1.12.0-linux-aarch64.tar.gz` |
| Windows x86_64 | `luna-v1.12.0-windows-x86_64.zip` |
| macOS Apple Silicon (arm64) | `luna-v1.12.0-macos-aarch64.tar.gz` |

```bash
# Linux / macOS (swap the asset name for your platform)
curl -LO https://github.com/k0b3n4irb/luna/releases/latest/download/luna-v1.12.0-linux-x86_64.tar.gz
tar xzf luna-v1.12.0-linux-x86_64.tar.gz && cd luna-v1.12.0-linux-x86_64
...
> `xattr -dr com.apple.quarantine luna-v1.12.0-macos-aarch64`, or right-click →
