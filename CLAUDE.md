...
| **HDMA / DMA faithful audit (PILLAR)** | `.claude/rules/hdma-dma-faithful-audit.md` | Edits to `luna-core/src/dma/`; any split/gradient/raster/status-bar layer bug. Drives `docs/hdma_ares_audit.md` (living audit vs ares). |
