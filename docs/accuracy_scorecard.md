...
| PPU | **A−** | Full feature set faithful (EXTBG, offset-per-tile, mosaic, interlace, hi-res 5/6, Mode 7, windows, color math). Open: gap #7 HiColor sub-scanline CGRAM timing (81% pixel-exact, `#[ignore]` tripwires keep it visible) | [`luna_bg_gaps.md`](luna_bg_gaps.md), [`luna_obj_gaps.md`](luna_obj_gaps.md), [`ppu_compositor_reference.md`](ppu_compositor_reference.md) | 2026-06-23 |
| DMA / HDMA | **A−** | **Pillar audit closed 2026-07-01**: every visual/behavioral row faithful (mid-frame enable = stale pointer, indirect last-active 1-byte quirk, count-0 header, MDMA preemption). Residuals = per-line cycle-count only (#11/#13) | [`hdma_ares_audit.md`](hdma_ares_audit.md), [`luna_dma_gaps.md`](luna_dma_gaps.md) | **2026-07-01** |
| SA-1 | **A−** | `conflict()` bus contention, faithful HV timer, per-access cycle cost; residual = batched (non-cothread) scheduler grain, not a value/feature bug | [`luna_sa1_gaps.md`](luna_sa1_gaps.md), [`sa1_status.md`](sa1_status.md) | 2026-06-23 |
